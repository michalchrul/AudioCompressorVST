...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright MichalChrul, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/AudioCompressor-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioCompressor-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioCompressor-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioCompressor-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioCompressor-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioCompressor-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/AudioCompressor-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/AudioCompressor.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AudioCompressor.iss",inplace=1):
